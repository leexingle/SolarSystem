...
public class SolarSystem extends JFrame 
{
	 ...
	 *
	 * @param distance the distance from this object to the point about which it is orbiting. (distance moon to planet)
	 * @param angle the angle (in degrees) that represents how far the object is around its orbit. (angle of moon to planet)
	 * @param diameter the size of the object.
	 * @param col the colour of this object, as a string. Case insentive. <p>One of: BLACK, BLUE, CYAN, DARK_GRAY, GRAY, GREEN, LIGHT_GRAY, 
	 * MAGENTA, ORANGE, PINK, RED, WHITE, YELLOW</p>
	 * @param centreOfRotationDistance the distance part of the polar co-ordinate about which this object orbits. (distance planet to sun)
	 * @param centreOfRotationAngle the angular part of the polar co-ordinate about which this object orbits. (angle planet to sun)
	 */
